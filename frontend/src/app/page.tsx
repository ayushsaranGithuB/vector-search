    ...
    <>
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2">
          <Card className="border-border/50 transition-colors hover:border-border">
            <CardHeader>
              ...
              <CardDescription>
                Search and retrieve information from Indian motor vehicle
                regulations and traffic laws with grounded citations.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-border/50 transition-colors hover:border-border">
            <CardHeader>
              ...
              <CardDescription>
                A second domain-specific knowledge project demonstrating the
                platform's reusability across different contexts.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" size="sm" disabled>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Modern vector search systems should work in practice — here is what
      ...
      <section className="border-t border-border bg-muted/30">
        <div className="mx-auto max-w-6xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              A modular, multi-project platform built for scale and
              observability.
            </p>
          </div>
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
